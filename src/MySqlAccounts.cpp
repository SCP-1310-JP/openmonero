...
bool
MysqlInputs::select(const uint64_t& address_id, vector<SinInput>& ins)
{

    Query query = conn->query(SinInput::SELECT_STMT);
    query.parse();
...
bool
MysqlInputs::select_for_tx(const uint64_t& address_id, vector<SinInput>& ins)
{

    Query query = conn->query(SinInput::SELECT_STMT2);
    query.parse();
...
bool
MysqlInputs::select_for_out(const uint64_t& output_id, vector<SinInput>& ins)
{

    Query query = conn->query(SinInput::SELECT_STMT3);
    query.parse();
...
uint64_t
MysqlInputs::insert(const SinInput& in_data)
{

    Query query = conn->query(SinInput::INSERT_STMT);
    query.parse();
...
bool
MysqlOutpus::select(const uint64_t& address_id, vector<SinOutput>& outs)
{
    Query query = conn->query(SinOutput::SELECT_STMT);
    query.parse();
...
bool
MysqlOutpus::select(const uint64_t& out_id, SinOutput& out)
{
    Query query = conn->query(SinOutput::SELECT_STMT3);
    query.parse();
...
bool
MysqlOutpus::select_for_tx(const uint64_t& tx_id, vector<SinOutput>& outs)
{
    Query query = conn->query(SinOutput::SELECT_STMT2);
    query.parse();
...
bool
MysqlOutpus::exist(const string& output_public_key_str, SinOutput& out)
{

    Query query = conn->query(SinOutput::EXIST_STMT);
    query.parse();
...
uint64_t
MysqlOutpus::insert(const SinOutput& out_data)
{
    Query query = conn->query(SinOutput::INSERT_STMT);
    query.parse();
...
bool
MysqlTransactions::select(const uint64_t& address_id, vector<SinTransaction>& txs)
{
    Query query = conn->query(SinTransaction::SELECT_STMT);
    query.parse();
...
uint64_t
MysqlTransactions::insert(const SinTransaction& tx_data)
{
    Query query = conn->query(SinTransaction::INSERT_STMT);
    query.parse();
...
{
    Query query = conn->query(SinTransaction::MARK_AS_SPENDABLE_STMT);
    query.parse();
...
{
    Query query = conn->query(SinTransaction::DELETE_STMT);
    query.parse();
...
bool
MysqlTransactions::exist(const uint64_t& account_id, const string& tx_hash_str, SinTransaction& tx)
{

    Query query = conn->query(SinTransaction::EXIST_STMT);
    query.parse();

    try
    {
        vector<SinTransaction> outs;
...
{
    Query query = conn->query(SinTransaction::SUM_SIN_RECIEVED);
    query.parse();
...
bool
MysqlPayments::select(const string& address, vector<SinPayment>& payments)
{

    Query query = conn->query(SinPayment::SELECT_STMT);
    query.parse();
...
bool
MysqlPayments::select_by_payment_id(const string& payment_id, vector<SinPayment>& payments)
{

    Query query = conn->query(SinPayment::SELECT_STMT2);
    query.parse();
...
uint64_t
MysqlPayments::insert(const SinPayment& payment_data)
{

    Query query = conn->query(SinPayment::INSERT_STMT);
    query.parse();
...
bool
MysqlPayments::update(SinPayment& payment_orginal, SinPayment& payment_new)
{
...
bool
MySqlAccounts::select(const string& address, SinAccount& account)
{

    Query query = conn->query(SinAccount::SELECT_STMT);
    query.parse();

    try
    {
        vector<SinAccount> res;
...
bool
MySqlAccounts::select(const int64_t& acc_id, SinAccount& account)
{
    ...
    Query query = conn->query(SinAccount::SELECT_STMT2);
    query.parse();
                      ...
                      uint64_t const& current_blkchain_height)
{
    ...
    Query query = conn->query(SinAccount::INSERT_STMT);
    query.parse();
...
uint64_t
MySqlAccounts::insert_tx(const SinTransaction& tx_data)
{
    return mysql_tx->insert(tx_data);
}

uint64_t
MySqlAccounts::insert_output(const SinOutput& tx_out)
{
    return mysql_out->insert(tx_out);
}

uint64_t
MySqlAccounts::insert_input(const SinInput& tx_in)
{
    return mysql_in->insert(tx_in);
}

bool
MySqlAccounts::select_txs(const string& sin_address, vector<SinTransaction>& txs)
{
    ...
    if (!select(sin_address, acc))
    {
        cerr << "Address" << sin_address << "does not exist in database" << endl;
        return false;
    }
...
bool
MySqlAccounts::select_txs(const uint64_t& account_id, vector<SinTransaction>& txs)
{
...
{
    vector<SinTransaction> txs_tmp;

    if (!select_txs(account_id, txs_tmp))
        return false;

    for (SinTransaction& tx: txs_tmp)
    {
...
//                                                "due to "
//                                                "sin_accounts->mark_tx_spendable(tx.id)");

                    cerr << "no_row_updated != 1 due to  sin_accounts->mark_tx_spendable(tx.id)\n";
                    return false;
                }
...
//                        throw runtime_error("no_row_updated != 1 "
//                                                    "due to "
//                                                    "sin_accounts->delete_tx(tx.id)");
                        cerr << "no_row_updated != 1 due to  sin_accounts->delete_tx(tx.id)\n";
                        return false;
                    }
...
bool
MySqlAccounts::select_outputs(const uint64_t& account_id, vector<SinOutput>& outs)
{
    return mysql_out->select(account_id, outs);
}

bool
MySqlAccounts::select_output_with_id(const uint64_t& out_id, SinOutput& out)
{
    return mysql_out->select(out_id, out);
}

bool
MySqlAccounts::select_outputs_for_tx(const uint64_t& tx_id, vector<SinOutput>& outs)
{
    return mysql_out->select_for_tx(tx_id, outs);
}

bool
MySqlAccounts::select_inputs(const uint64_t& account_id, vector<SinInput>& ins)
{
...
bool
MySqlAccounts::select_inputs_for_tx(const uint64_t& tx_id, vector<SinInput>& ins)
{
...
bool
MySqlAccounts::select_inputs_for_out(const uint64_t& output_id, vector<SinInput>& ins)
{
    return mysql_in->select_for_out(output_id, ins);
}

bool
MySqlAccounts::output_exists(const string& output_public_key_str, SinOutput& out)
{
    return mysql_out->exist(output_public_key_str, out);
}

bool
MySqlAccounts::tx_exists(const uint64_t& account_id, const string& tx_hash_str, SinTransaction& tx)
{
...
uint64_t
MySqlAccounts::insert_payment(const SinPayment& payment)
{
    return mysql_payment->insert(payment);
}

bool
MySqlAccounts::select_payment_by_id(const string& payment_id, vector<SinPayment>& payments)
{
    return mysql_payment->select_by_payment_id(payment_id, payments);
}

bool
MySqlAccounts::select_payment_by_address(const string& address, vector<SinPayment>& payments)
{
    return mysql_payment->select(address, payments);
}

bool
MySqlAccounts::select_payment_by_address(const string& address, SinPayment& payment)
{

    vector<SinPayment> payments;
...
bool
MySqlAccounts::update_payment(SinPayment& payment_orginal, SinPayment& payment_new)
{
...
bool
MySqlAccounts::update(SinAccount& acc_orginal, SinAccount& acc_new)
{
