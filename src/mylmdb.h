...
//
#ifndef SINLMDBCPP_MYLMDB_H
#define SINLMDBCPP_MYLMDB_H
...
std::ostream& operator<<(std::ostream& os, const output_info&  out_info)
{
     os  << ", out_pub_key: " << out_info.out_pub_key
         ...
         << ", amount: " << SIN_AMOUNT(out_info.amount)
