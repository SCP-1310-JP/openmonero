...
--
-- Database: `openscp1310jp1`
--
CREATE DATABASE IF NOT EXISTS `openscp1310jp1` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `openscp1310jp1`;
...
CREATE TABLE `Payments` (
  ...
  `payment_address` varchar(195) NOT NULL,
